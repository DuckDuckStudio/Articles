...
- [`Please install zenity before continuing!`](#21-安装-zenity)
- [`Please install unzip before continuing!`](#22-安装-unzip)
- [`Dependencies install failed, check apt or your connection..` (64位系统)](#23-启用-32-位支持)
- [apparmor限制](#24-apparmor限制)
